...
### 🔹 Breast Cancer Detection using ANN (PyTorch)
- **Type:** Tutorial / Code  
...
### 🔹 Recurrent Neural Networks & LSTM Basics
- **Type:** Tutorial / Theory  
...
### 🔹 Practical Implementation of Gradient Stability
- **Type:** Tutorial / Code  
...
### 🔹 Transformer Architecture – Input & Preprocessing
- **Type:** Tutorial / Theory  
- Tokenization
- Word embeddings
- Positional encoding
...
### 🔹 Attention Mechanism (Context Formation)
- **Type:** Tutorial / Theory  
...
### 🔹 Research Paper Study – *Attention Is All You Need*
- **Type:** Tutorial / Theory  
- Studied:
...
| Encoder–Decoder | T5 | Seq-to-Seq Tasks |

---

### 🔹 BERT and GPT – Comparative Study
- **Type:** Tutorial / Theory  
- BERT:
